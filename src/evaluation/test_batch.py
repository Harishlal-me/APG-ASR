...
def main():
    ...
    out_md = r"d:\cdacminor\experiments\apg_asr\batch_results.md"
    ...
    with open(out_md, "w") as f:
        f.write("# APG-ASR Agentic Layer Batch Evaluation\n\n")
        ...
        for i, img_path in enumerate(images_to_test):
            ...
            try:
                ...
                proc_dir = r"d:\cdacminor\experiments\apg_asr\batch_outputs\processed"
    ...
    import json
    json_out = r"d:\cdacminor\experiments\apg_asr\batch_results.json"
